...
These scripts can only be run with Unity installed as the debug message will only appear in the unity console.  To run these test, one can load the unity project contained in 3_integration_testing/NetworkTest and run the code in the console.  The output of these test should appear in the console in Unity.
